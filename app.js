...
// (async () => 
// {
//     console.log(await bcrypt.hash('ghmoaavia',7));
//     console.log(await bcrypt.hash('naltaaf',7));
//     console.log(await bcrypt.hash('yabangash',7));
//     console.log(await bcrypt.hash('mzrafee',7));
// })();
